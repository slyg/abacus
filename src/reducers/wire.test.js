...
describe('wire reducer', () => {
  ...
  it('should increment left value and decrement on right value on INCREMENT message', () => {
    ...
    const state1 = reducer(10)(state0, {type: INCREMENT, index: 7})
  ...
  it('should decrement left value and increment on right value on DECREMENT message', () => {
    const state0 = reducer(10)(undefined, {type: NOOP})
    const state1 = reducer(10)(state0, {type: INCREMENT, index: 0})
    const state2 = reducer(10)(state1, {type: DECREMENT, index: 3})
